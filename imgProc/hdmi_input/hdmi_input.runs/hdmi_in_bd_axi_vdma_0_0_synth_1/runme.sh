...
HD_PWD='C:/imgProc/attempt4/hdmi_input/hdmi_input.runs/hdmi_in_bd_axi_vdma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_bd_axi_vdma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_in_bd_axi_vdma_0_0.tcl
