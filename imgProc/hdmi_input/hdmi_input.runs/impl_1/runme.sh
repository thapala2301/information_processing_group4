...
HD_PWD='C:/imgProc/attempt4/hdmi_input/hdmi_input.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_in_bd_wrapper.tcl -notrace
