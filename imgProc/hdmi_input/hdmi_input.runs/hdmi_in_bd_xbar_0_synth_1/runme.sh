...
HD_PWD='C:/imgProc/attempt3lol/hdmi_input/hdmi_input.runs/hdmi_in_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_in_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_in_bd_xbar_0.tcl
