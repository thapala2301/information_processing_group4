set moduleName AXIvideo2xfMat_24_9_1080_1920_1_s
set isTopModule 0
...
set C_modelName {AXIvideo2xfMat<24, 9, 1080, 1920, 1>}
set C_modelType { void 0 }
set C_modelArgList {
	{ img_in_432 int 24 regular {fifo 1 volatile }  }
	...
	{ img_1_out int 32 regular {fifo 1}  }
	{ img_2_out int 32 regular {fifo 1}  }
}
set C_modelArgMapList {[ 
	{ "Name" : "img_in_432", "interface" : "fifo", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
 	...
 	{ "Name" : "img_1_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} , 
 	{ "Name" : "img_2_out", "interface" : "fifo", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ img_in_432_din sc_out sc_lv 24 signal 0 } 
	{ img_in_432_full_n sc_in sc_logic 1 signal 0 } 
	{ img_in_432_write sc_out sc_logic 1 signal 0 } 
	{ video_in_TDATA sc_in sc_lv 24 signal 1 } 
	{ video_in_TVALID sc_in sc_logic 1 invld 7 } 
	...
	{ img_1_dout sc_in sc_lv 32 signal 8 } 
	{ img_1_empty_n sc_in sc_logic 1 signal 8 } 
	{ img_1_read sc_out sc_logic 1 signal 8 } 
	{ img_2_dout sc_in sc_lv 32 signal 9 } 
	{ img_2_empty_n sc_in sc_logic 1 signal 9 } 
	{ img_2_read sc_out sc_logic 1 signal 9 } 
	{ img_1_out_din sc_out sc_lv 32 signal 10 } 
	{ img_1_out_full_n sc_in sc_logic 1 signal 10 } 
	{ img_1_out_write sc_out sc_logic 1 signal 10 } 
	{ img_2_out_din sc_out sc_lv 32 signal 11 } 
	{ img_2_out_full_n sc_in sc_logic 1 signal 11 } 
	{ img_2_out_write sc_out sc_logic 1 signal 11 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "img_in_432_din", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "img_in_432", "role": "din" }} , 
 	{ "name": "img_in_432_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_in_432", "role": "full_n" }} , 
 	{ "name": "img_in_432_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_in_432", "role": "write" }} , 
 	...
 	{ "name": "img_1_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "img_1_out", "role": "din" }} , 
 	{ "name": "img_1_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_1_out", "role": "full_n" }} , 
 	{ "name": "img_1_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_1_out", "role": "write" }} , 
 	{ "name": "img_2_out_din", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "img_2_out", "role": "din" }} , 
 	{ "name": "img_2_out_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_2_out", "role": "full_n" }} , 
 	{ "name": "img_2_out_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "img_2_out", "role": "write" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "5", "6", "7"],
		...
		"Port" : [
			{"Name" : "img_in_432", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "img_1_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_1_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_2_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "3", "Max" : "2080084"}
	, {"Name" : "Interval", "Min" : "3", "Max" : "2080084"}
]}
...
set Spec2ImplPortList { 
	img_in_432 { ap_fifo {  { img_in_432_din fifo_data 1 24 }  { img_in_432_full_n fifo_status 0 1 }  { img_in_432_write fifo_update 1 1 } } }
	...
	img_1_out { ap_fifo {  { img_1_out_din fifo_data 1 32 }  { img_1_out_full_n fifo_status 0 1 }  { img_1_out_write fifo_update 1 1 } } }
	img_2_out { ap_fifo {  { img_2_out_din fifo_data 1 32 }  { img_2_out_full_n fifo_status 0 1 }  { img_2_out_write fifo_update 1 1 } } }
}
