; ModuleID = 'C:/Users/archit/OneDrive/Documents/Work/infoproc/accel_downscale/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream" = type { %"struct.hls::axis" }
%"struct.hls::axis" = type { %struct.ap_uint, %struct.ap_uint.10, %struct.ap_uint.10, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.13 }
...
%struct.ssdm_int.12 = type { i3 }
%struct.ap_uint.13 = type { %struct.ap_int_base.14 }
%struct.ap_int_base.14 = type { %struct.ssdm_int.15 }
%struct.ssdm_int.15 = type { i1 }
%"class.hls::stream.0" = type { %"struct.hls::axis.16" }
%"struct.hls::axis.16" = type { %struct.ap_uint.6, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.13, %struct.ap_uint.13 }
%struct.ap_uint.6 = type { %struct.ap_int_base.7 }
%struct.ap_int_base.7 = type { %struct.ssdm_int.8 }
%struct.ssdm_int.8 = type { i8 }

; Function Attrs: noinline
define void @apatb_image_accelerator_ir(%"class.hls::stream"* %video_in, %"class.hls::stream.0"* %video_out, i32 %in_rows, i32 %in_cols, i32 %out_rows, i32 %out_cols) local_unnamed_addr #0 {
entry:
  %video_in_copy = alloca %"class.hls::stream", align 512
  %video_out_copy = alloca %"class.hls::stream.0", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %video_in, %"class.hls::stream"* nonnull align 512 %video_in_copy, %"class.hls::stream.0"* %video_out, %"class.hls::stream.0"* nonnull align 512 %video_out_copy)
  call void @apatb_image_accelerator_hw(%"class.hls::stream"* %video_in_copy, %"class.hls::stream.0"* %video_out_copy, i32 %in_rows, i32 %in_cols, i32 %out_rows, i32 %out_cols)
  call fastcc void @copy_out(%"class.hls::stream"* %video_in, %"class.hls::stream"* nonnull align 512 %video_in_copy, %"class.hls::stream.0"* %video_out, %"class.hls::stream.0"* nonnull align 512 %video_out_copy)
  ret void
}
...
; <label>:34:                                     ; preds = %31, %30, %26, %22
  ...
  %35 = bitcast %struct.ap_uint.10* %.0.218 to i8*
  %36 = call i1 @fpga_fifo_exist_1(i8* %35)
  br i1 %36, label %37, label %38

; <label>:37:                                     ; preds = %34
  call fastcc void @streamcpy_hls.p0struct.ap_uint.10(%struct.ap_uint.10* %.01.219, %struct.ap_uint.10* %.0.218)
  br label %49
...
; <label>:38:                                     ; preds = %34
  ...
  %39 = bitcast %struct.ap_int_base.11* %.0.2.020 to i8*
  %40 = call i1 @fpga_fifo_exist_1(i8* %39)
  br i1 %40, label %41, label %42

; <label>:41:                                     ; preds = %38
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.11(%struct.ap_int_base.11* %.01.2.021, %struct.ap_int_base.11* %.0.2.020)
  br label %49
...
; <label>:42:                                     ; preds = %38
  ...
  %43 = bitcast %struct.ssdm_int.12* %.0.2.0.022 to i8*
  %44 = call i1 @fpga_fifo_exist_1(i8* %43)
  br i1 %44, label %45, label %46

; <label>:45:                                     ; preds = %42
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.12(%struct.ssdm_int.12* %.01.2.0.023, %struct.ssdm_int.12* %.0.2.0.022)
  br label %49
...
; <label>:49:                                     ; preds = %46, %45, %41, %37
  ...
  %50 = bitcast %struct.ap_uint.13* %.0.326 to i8*
  %51 = call i1 @fpga_fifo_exist_1(i8* %50)
  br i1 %51, label %52, label %53

; <label>:52:                                     ; preds = %49
  call fastcc void @streamcpy_hls.p0struct.ap_uint.13(%struct.ap_uint.13* %.01.327, %struct.ap_uint.13* %.0.326)
  br label %64
...
; <label>:53:                                     ; preds = %49
  ...
  %54 = bitcast %struct.ap_int_base.14* %.0.3.028 to i8*
  %55 = call i1 @fpga_fifo_exist_1(i8* %54)
  br i1 %55, label %56, label %57

; <label>:56:                                     ; preds = %53
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.14(%struct.ap_int_base.14* %.01.3.029, %struct.ap_int_base.14* %.0.3.028)
  br label %64
...
; <label>:57:                                     ; preds = %53
  ...
  %58 = bitcast %struct.ssdm_int.15* %.0.3.0.030 to i8*
  %59 = call i1 @fpga_fifo_exist_1(i8* %58)
  br i1 %59, label %60, label %61

; <label>:60:                                     ; preds = %57
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.15(%struct.ssdm_int.15* %.01.3.0.031, %struct.ssdm_int.15* %.0.3.0.030)
  br label %64
...
; <label>:64:                                     ; preds = %61, %60, %56, %52
  ...
  %65 = bitcast %struct.ap_uint.13* %.0.434 to i8*
  %66 = call i1 @fpga_fifo_exist_1(i8* %65)
  br i1 %66, label %67, label %68

; <label>:67:                                     ; preds = %64
  call fastcc void @streamcpy_hls.p0struct.ap_uint.13(%struct.ap_uint.13* %.01.435, %struct.ap_uint.13* %.0.434)
  br label %79
...
; <label>:68:                                     ; preds = %64
  ...
  %69 = bitcast %struct.ap_int_base.14* %.0.4.036 to i8*
  %70 = call i1 @fpga_fifo_exist_1(i8* %69)
  br i1 %70, label %71, label %72

; <label>:71:                                     ; preds = %68
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.14(%struct.ap_int_base.14* %.01.4.037, %struct.ap_int_base.14* %.0.4.036)
  br label %79
...
; <label>:72:                                     ; preds = %68
  ...
  %73 = bitcast %struct.ssdm_int.15* %.0.4.0.038 to i8*
  %74 = call i1 @fpga_fifo_exist_1(i8* %73)
  br i1 %74, label %75, label %76

; <label>:75:                                     ; preds = %72
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.15(%struct.ssdm_int.15* %.01.4.0.039, %struct.ssdm_int.15* %.0.4.0.038)
  br label %79
...
; <label>:79:                                     ; preds = %76, %75, %71, %67
  ...
  %80 = bitcast %struct.ap_uint.13* %.0.542 to i8*
  %81 = call i1 @fpga_fifo_exist_1(i8* %80)
  br i1 %81, label %82, label %83

; <label>:82:                                     ; preds = %79
  call fastcc void @streamcpy_hls.p0struct.ap_uint.13(%struct.ap_uint.13* %.01.543, %struct.ap_uint.13* %.0.542)
  br label %94
...
; <label>:83:                                     ; preds = %79
  ...
  %84 = bitcast %struct.ap_int_base.14* %.0.5.044 to i8*
  %85 = call i1 @fpga_fifo_exist_1(i8* %84)
  br i1 %85, label %86, label %87

; <label>:86:                                     ; preds = %83
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.14(%struct.ap_int_base.14* %.01.5.045, %struct.ap_int_base.14* %.0.5.044)
  br label %94
...
; <label>:87:                                     ; preds = %83
  ...
  %88 = bitcast %struct.ssdm_int.15* %.0.5.0.046 to i8*
  %89 = call i1 @fpga_fifo_exist_1(i8* %88)
  br i1 %89, label %90, label %91

; <label>:90:                                     ; preds = %87
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.15(%struct.ssdm_int.15* %.01.5.0.047, %struct.ssdm_int.15* %.0.5.0.046)
  br label %94
...
; <label>:94:                                     ; preds = %91, %90, %86, %82
  ...
  %95 = bitcast %struct.ap_uint.13* %.0.650 to i8*
  %96 = call i1 @fpga_fifo_exist_1(i8* %95)
  br i1 %96, label %97, label %98

; <label>:97:                                     ; preds = %94
  call fastcc void @streamcpy_hls.p0struct.ap_uint.13(%struct.ap_uint.13* %.01.651, %struct.ap_uint.13* %.0.650)
  br label %ret
...
; <label>:98:                                     ; preds = %94
  ...
  %99 = bitcast %struct.ap_int_base.14* %.0.6.052 to i8*
  %100 = call i1 @fpga_fifo_exist_1(i8* %99)
  br i1 %100, label %101, label %102

; <label>:101:                                    ; preds = %98
  call fastcc void @streamcpy_hls.p0struct.ap_int_base.14(%struct.ap_int_base.14* %.01.6.053, %struct.ap_int_base.14* %.0.6.052)
  br label %ret
...
; <label>:102:                                    ; preds = %98
  ...
  %103 = bitcast %struct.ssdm_int.15* %.0.6.0.054 to i8*
  %104 = call i1 @fpga_fifo_exist_1(i8* %103)
  br i1 %104, label %105, label %106

; <label>:105:                                    ; preds = %102
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.15(%struct.ssdm_int.15* %.01.6.0.055, %struct.ssdm_int.15* %.0.6.0.054)
  br label %ret
...
copy:                                             ; preds = %entry
  %5 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
; <label>:18:                                     ; preds = %17, %16, %13, %10
  ...
  %19 = bitcast %struct.ap_uint.13* %.0.110 to i8*
...
; <label>:22:                                     ; preds = %18
  ...
  %23 = bitcast %struct.ap_int_base.14* %.0.1.012 to i8*
...
; <label>:26:                                     ; preds = %22
  ...
  %27 = bitcast %struct.ssdm_int.15* %.0.1.0.014 to i8*
  %28 = call i1 @fpga_fifo_exist_1(i8* %27)
  br i1 %28, label %29, label %30

; <label>:29:                                     ; preds = %26
  call fastcc void @streamcpy_hls.p0struct.ssdm_int.15(%struct.ssdm_int.15* %.01.1.0.015, %struct.ssdm_int.15* %.0.1.0.014)
  br label %33

; <label>:30:                                     ; preds = %26
  %.01.1.0.0.017.gep58 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
  %31 = bitcast i1* %.01.1.0.0.017.gep58 to i8*
  %.0.1.0.0.016.gep59 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 1, i32 0, i32 0, i32 0
...
; <label>:33:                                     ; preds = %30, %29, %25, %21
  ...
  %34 = bitcast %struct.ap_uint.13* %.0.218 to i8*
...
; <label>:37:                                     ; preds = %33
  ...
  %38 = bitcast %struct.ap_int_base.14* %.0.2.020 to i8*
...
; <label>:41:                                     ; preds = %37
  ...
  %42 = bitcast %struct.ssdm_int.15* %.0.2.0.022 to i8*
...
; <label>:45:                                     ; preds = %41
  %.01.2.0.0.025.gep60 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
  %46 = bitcast i1* %.01.2.0.0.025.gep60 to i8*
  %.0.2.0.0.024.gep61 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 2, i32 0, i32 0, i32 0
...
; <label>:48:                                     ; preds = %45, %44, %40, %36
  ...
  %49 = bitcast %struct.ap_uint.13* %.0.326 to i8*
...
; <label>:52:                                     ; preds = %48
  ...
  %53 = bitcast %struct.ap_int_base.14* %.0.3.028 to i8*
...
; <label>:56:                                     ; preds = %52
  ...
  %57 = bitcast %struct.ssdm_int.15* %.0.3.0.030 to i8*
...
; <label>:60:                                     ; preds = %56
  %.01.3.0.0.033.gep62 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
  %61 = bitcast i1* %.01.3.0.0.033.gep62 to i8*
  %.0.3.0.0.032.gep63 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 3, i32 0, i32 0, i32 0
...
; <label>:63:                                     ; preds = %60, %59, %55, %51
  ...
  %64 = bitcast %struct.ap_uint.13* %.0.434 to i8*
...
; <label>:67:                                     ; preds = %63
  ...
  %68 = bitcast %struct.ap_int_base.14* %.0.4.036 to i8*
...
; <label>:71:                                     ; preds = %67
  ...
  %72 = bitcast %struct.ssdm_int.15* %.0.4.0.038 to i8*
...
; <label>:75:                                     ; preds = %71
  %.01.4.0.0.041.gep64 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
  %76 = bitcast i1* %.01.4.0.0.041.gep64 to i8*
  %.0.4.0.0.040.gep65 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 4, i32 0, i32 0, i32 0
...
; <label>:78:                                     ; preds = %75, %74, %70, %66
  ...
  %79 = bitcast %struct.ap_uint.13* %.0.542 to i8*
...
; <label>:82:                                     ; preds = %78
  ...
  %83 = bitcast %struct.ap_int_base.14* %.0.5.044 to i8*
...
; <label>:86:                                     ; preds = %82
  ...
  %87 = bitcast %struct.ssdm_int.15* %.0.5.0.046 to i8*
...
; <label>:90:                                     ; preds = %86
  %.01.5.0.0.049.gep66 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
  %91 = bitcast i1* %.01.5.0.0.049.gep66 to i8*
  %.0.5.0.0.048.gep67 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 5, i32 0, i32 0, i32 0
...
; <label>:93:                                     ; preds = %90, %89, %85, %81
  ...
  %94 = bitcast %struct.ap_uint.13* %.0.650 to i8*
...
; <label>:97:                                     ; preds = %93
  ...
  %98 = bitcast %struct.ap_int_base.14* %.0.6.052 to i8*
...
; <label>:101:                                    ; preds = %97
  ...
  %102 = bitcast %struct.ssdm_int.15* %.0.6.0.054 to i8*
...
; <label>:105:                                    ; preds = %101
  %.01.6.0.0.057.gep68 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
  %106 = bitcast i1* %.01.6.0.0.057.gep68 to i8*
  %.0.6.0.0.056.gep69 = getelementptr %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 6, i32 0, i32 0, i32 0
...
ret:                                              ; preds = %empty
  %10 = getelementptr inbounds %"class.hls::stream.0", %"class.hls::stream.0"* %1, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
  %11 = getelementptr inbounds %"class.hls::stream.0", %"class.hls::stream.0"* %0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0
...
declare void @apatb_image_accelerator_hw(%"class.hls::stream"*, %"class.hls::stream.0"*, i32, i32, i32, i32)

define void @image_accelerator_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream.0"*, i32, i32, i32, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  call void @image_accelerator_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream.0"* %1, i32 %2, i32 %3, i32 %4, i32 %5)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream.0"* null, %"class.hls::stream.0"* %1)
  ret void
}

declare void @image_accelerator_hw_stub(%"class.hls::stream"*, %"class.hls::stream.0"*, i32, i32, i32, i32)
